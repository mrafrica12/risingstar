(function () {
  ...
  function tournamentCard(t, featured) {
    ...
    return `<article class="t-card reveal ${featured ? '' : 'reveal-delay-1'}">
      ...
      <div class="t-card-body">
        ...
        <br><a href="${esc(pagePath(t.registrationUrl || 'register.html'))}" class="btn-primary" style="font-size:10px;padding:12px 24px">Register ↗</a>
      </div>
    </article>`;
  }
  ...
  function programCard(p) {
    ...
    return `<div class="prog-card reveal">
      ...
      <div class="prog-price"><div><span class="prog-price-num">${esc(p.price || '')}</span></div><a href="${esc(pagePath(p.registrationUrl || 'register.html'))}">Register ↗</a></div>
    </div>`;
  }
  ...
  function cmsTournamentTile(t) {
    return `<article class="cms-card">
      ...
      <div class="cms-card-body">
        ...
        <a class="btn-primary" href="${esc(pagePath(t.registrationUrl || 'register.html'))}">Register ↗</a>
      </div>
    </article>`;
  }
